...
Ext.MessageBox = function(){
    ...
    var bodyEl, msgEl, textboxEl, textareaEl, progressEl, pp, eMsgEl, comboEl;
    ...
    var handleValidation = function(){
		if(opt.validator) {
			...
			var eMsg = isValid ? '' : (typeof(result) == 'object') ? result.join('<br />&nbsp;') : result;
			Ext.MessageBox.updateText(opt.msg, eMsg);
    ...
    var handleButton = function(button){
        dlg.hide();
        Ext.callback(opt.fn, opt.scope||window, [button, activeTextEl.dom.value || comboEl.dom.value], 1);
    };
    ...
    return {
        ...
        getDialog : function(){
			...
			bodyEl = dlg.body.createChild({
				tag:"div",
				html:'<span class="ext-mb-text"></span><br /><input type="text" class="ext-mb-input" /><textarea class="ext-mb-textarea"></textarea><input type="combo" class="ext-mb-combo"><span class="ext-mb-eMsg">&nbsp;</span><div class="ext-mb-progress-wrap"><div class="ext-mb-progress"><div class="ext-mb-progress-bar">&#160;</div></div></div>'
			});
			...
			textareaEl.on('keyup', scheduleValidation);
			textboxEl.on('keyup', scheduleValidation);
			comboEl = Ext.get(bodyEl.dom.childNodes[4]);
...
Ext.Msg.show({
   ...
   animEl: 'addAddressBtn'
         ...
         * @return {Ext.MessageBox} messageBox This message box
         */
        prompt : function(title, msg, fn, scope, multiline, validator, combo){
            this.show({
                title : title,
                msg : msg,
